...
namespace EntryPoint
{
    public static class HW3
    {
        ...
        {
            Console.WriteLine("\nEx2");
            double number = UI.GetNumberFromUser("a");
        ...
        {
            Console.WriteLine("\nEx6");
            double valueN = UI.GetNumberFromUser("n");
            int fibonachiN = 1;
            int previous1 = 0;
            int previous2 = 1;
        ...
        {
            Console.WriteLine("\nEx7");
            double evklidA = UI.GetNumberFromUser("a");
            double evklidB = UI.GetNumberFromUser("b");
            double nod;
            double tmpEvklid;
            if (evklidA > evklidB)
            {
        ...
        {
            Console.WriteLine("\nEx8");
            double cubeN = UI.GetNumberFromUser("n");
            double left = 0;
            double mid = 0;
            double right = cubeN;
        ...
        {
            Console.WriteLine("\nEx9");
            double a = UI.GetNumberFromUser("a");
            double count = 0;
            double tmp = 0;
            while (a > 0)
            {
        ...
        {
            Console.WriteLine("\nEx10");
            double input = UI.GetNumberFromUser("a");
            double number = 0;
            while (input > 0)
            {
        ...
        {
            Console.WriteLine("\nEx11");
            double n = UI.GetNumberFromUser("n");
            double sumOfEven = 0;
